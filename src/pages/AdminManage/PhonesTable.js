...
const PhonesTable = ({
  ...
  return (
    ...
    >
      ...
      >
        <thead
          style={{ backgroundColor: "#4a6fa5", color: "#fff", borderBottom: "3px solid black" }}
        >
          <tr>
          ...
          <Form>
            <Form.Group>
              ...
              <Form.Select
                ...
                onChange={(e) => setNewPhone({ ...newPhone, modelId: Number(e.target.value) })}
              >
            ...
            <Form.Group>
              ...
              <Form.Control
                ...
                onChange={(e) => setNewPhone({ ...newPhone, price: Number(e.target.value) })}
              />
            </Form.Group>
            <Form.Group>
          ...
          <Form>
            <Form.Group>
              ...
              <Form.Select
                ...
                onChange={(e) => setEditPhone({ ...editPhone, modelId: Number(e.target.value) })}
              >
                <option value="" disabled>
                  Select a model
                </option>
            ...
            <Form.Group>
              ...
              <Form.Control
                ...
                onChange={(e) => setEditPhone({ ...editPhone, image: e.target.value })}
              />
            </Form.Group>
            <Form.Group>
              <Form.Label>Chipset</Form.Label>
              <Form.Control
                ...
                onChange={(e) => setEditPhone({ ...editPhone, chipset: e.target.value })}
              />
            </Form.Group>
            <Form.Group>
              <Form.Label>GPU</Form.Label>
              <Form.Control
                ...
                placeholder="Enter GPU"
                value={editPhone?.gpu || ""}
                onChange={(e) => setEditPhone({ ...editPhone, gpu: e.target.value })}
              />
            </Form.Group>
            <Form.Group>
              <Form.Label>Color</Form.Label>
              <Form.Control
                ...
                onChange={(e) => setEditPhone({ ...editPhone, color: e.target.value })}
              />
            </Form.Group>
            <Form.Group>
              <Form.Label>Warranty Period (Months)</Form.Label>
